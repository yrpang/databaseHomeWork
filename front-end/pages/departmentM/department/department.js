// pages/departmentM/departmentM.js
const app = getApp()
...
Page({
  ...
  toItem: function (e) {
    console.log(e)
    wx.navigateTo({
      url: '../departmentItem/departmentItem?id=' + e.currentTarget.id,
    })
  },
  ...
  delete: function (e) {
    console.log(e)
    wx.request({
      url: app.globalData.baseURL + 'department/' + e.currentTarget.id,
      method: "DELETE",
      success: res => {
  ...
  add: function () {
    wx.navigateTo({
      url: '../departmentItem/departmentItem?id=-1'
    })
  },
